...
function App() {
  ...
  const langCode = "ko"; //언어코드 중국어간체(cn1)

  const API_URL = `http://apis.data.go.kr/B551011/Odii/themeBasedList?serviceKey=${API_KEY}&MobileOS=ETC&MobileApp=AppTest&pageNo=${pageNo}&numOfRows=${numOfRows}&langCode=${langCode}&_type=json`;
