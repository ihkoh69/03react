...
function App() {
  ...
  const API_URL = `http://apis.data.go.kr/B551011/PhotoGalleryService1/gallerySearchList1?serviceKey=${API_KEY}&MobileOS=ETC&MobileApp=AppTest&keyword=${keyword}&numOfRows=100&pageNo=1&_type=json`;
