...
function App() {
  ...
  const API_URL = `http://apis.data.go.kr/B551011/DataLabService/metcoRegnVisitrDDList?serviceKey=${API_KEY}&MobileOS=ETC&MobileApp=AppTest&startYmd=${startYmd}&endYmd=${endYmd}&pageNo=${pageNo}&numOfRows=${numOfRows}&_type=json`;
