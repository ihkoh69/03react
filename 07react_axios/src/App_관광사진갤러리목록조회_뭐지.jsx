...
function App() {
  ...
  const API_URL = `http://apis.data.go.kr/B551011/PhotoGalleryService1/galleryList1?serviceKey=${API_KEY}&arrange=C&MobileOS=ETC&MobileApp=AppTesting&numOfRows=1&pageNo=1&_type=json`;
              ...
              return (
                <>
                  <tr>
                    ...
                    <td>{item.galTitle}</td>
                    <td>
                      <a href={item.galWebImageUrl} target="_blank">
                        갤러리 보기
                      </a>
                    </td>
                  </tr>
